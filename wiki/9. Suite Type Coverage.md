...
- **Medium**: AnyRefSpec and other reflection-driven styles may require dedicated discovery/matching logic.
...
1. **ScalaTest: implement AnyRefSpec/RefSpec-like discovery**.
