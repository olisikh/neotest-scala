...
`!` operator examples are also detected when written in block form:

```scala
class BangOperatorSpec extends Specification {
  "works" ! {
    1 mustEqual 1
  }
}
