...
describe("framework", function()
  ...
  describe("supports_dap_test_selector", function()
    it("returns true for selector-capable frameworks", function()
      assert.is_true(fw.supports_dap_test_selector("scalatest"))
      assert.is_true(fw.supports_dap_test_selector("munit"))
      assert.is_true(fw.supports_dap_test_selector("specs2"))
      assert.is_true(fw.supports_dap_test_selector("zio-test"))
    end)

    it("returns false for unsupported frameworks", function()
      assert.is_false(fw.supports_dap_test_selector("utest"))
      assert.is_false(fw.supports_dap_test_selector("unknown"))
      assert.is_false(fw.supports_dap_test_selector(nil))
    end)
  end)
end)
